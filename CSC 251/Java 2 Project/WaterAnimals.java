...
/**
 * WaterAnimals class implements Animal interface
 *
 */
public   class WaterAnimals implements Animal {
	...
	public WaterAnimals(String a_name, String c_lass, String genus, String order, String group, String family, int height, int weight, String subExhibit, String funFacts, String status, int tagNumber) {
		this.a_name = a_name;
		this.c_lass = c_lass;
		this.genus = genus;
		this.order = order;
	...
	public String toString() {
		return "WaterAnimals [a_name=" + a_name + ", c_lass=" + c_lass + ", genus=" + genus + ", order=" + order
				+ ", family=" + family + ", height=" + height + ", weight=" + weight + ", subExhibit=" + subExhibit
				+ ", funFacts=" + funFacts + ", status=" + status + ", tagNumber=" + tagNumber + "]";
	}
